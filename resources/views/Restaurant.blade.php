               ...
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="team-thumb wow fadeInUp" data-wow-delay="0.2s">
                              <img src="{{ asset("web/images/team-image1.jpg") }}" class="img-responsive" alt="">
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="team-thumb wow fadeInUp" data-wow-delay="0.4s">
                              <img src="{{ asset("web/images/team-image2.jpg") }}" class="img-responsive" alt="">
                                   <div class="team-hover">
                                        <div class="team-item">
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="team-thumb wow fadeInUp" data-wow-delay="0.6s">
                              <img src="{{ asset("web/images/team-image3.jpg") }}" class="img-responsive" alt="">
                                   <div class="team-hover">
                                        <div class="team-item">
               ...
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                         ...
                         <div class="menu-thumb">
                              <a href="{{ asset("web/images/menu-image1.jpg") }}" class="image-popup" title="American Breakfast">
                                   <img src="{{ asset("web/images/menu-image1.jpg") }}" class="img-responsive" alt="">
                    ...
                    <div class="col-md-4 col-sm-6">
                         <!-- MENU THUMB -->
                         <div class="menu-thumb">
                              <a href="{{ asset("web/images/menu-image2.jpg") }}" class="image-popup" title="Self-made Salad">
                                   <img src="{{ asset("web/images/menu-image2.jpg") }}" class="img-responsive" alt="">
                    ...
                    <div class="col-md-4 col-sm-6">
                         <!-- MENU THUMB -->
                         <div class="menu-thumb">
                              <a href="{{ asset("web/images/menu-image3.jpg") }}" class="image-popup" title="Chinese Noodle">
                                   <img src="{{ asset("web/images/menu-image3.jpg") }}" class="img-responsive" alt="">
                    ...
                    <div class="col-md-4 col-sm-6">
                         <!-- MENU THUMB -->
                         <div class="menu-thumb">
                              <a href="{{ asset("web/images/menu-image4.jpg") }}" class="image-popup" title="Rice Soup">
                                   <img src="{{ asset("web/images/menu-image4.jpg") }}" class="img-responsive" alt="">
                    ...
                    <div class="col-md-4 col-sm-6">
                         <!-- MENU THUMB -->
                         <div class="menu-thumb">
                              <a href="{{ asset("web/images/menu-image5.jpg") }}" class="image-popup" title="Project title">
                                   <img src="{{ asset("web/images/menu-image5.jpg") }}" class="img-responsive" alt="">
                    ...
                    <div class="col-md-4 col-sm-6">
                         <!-- MENU THUMB -->
                         <div class="menu-thumb">
                              <a href="{{ asset("web/images/menu-image6.jpg") }}" class="image-popup" title="Project title">
                                   <img src="{{ asset("web/images/menu-image6.jpg") }}" class="img-responsive" alt="">
                         ...
                         <form action="{{ route('reservation')}}" method="post" class="wow fadeInUp" id="contact-form" role="form" data-wow-delay="0.8s">
                           ...
                           <p class="text-danger">
                            ...
                            @enderror
                              ...
                              <div class="col-md-6 col-sm-6">
                                <input type="text" class="form-control" id="cf-email" name="number" placeholder="Phone No#">
                                <p class="text-danger">
                                    @error('number')
                                    {{ $message}}
                                    @enderror
                           ...
                           <div class="col-md-6 col-sm-6">
                            <input type="text" class="form-control" id="cf-email" name="nog" placeholder="No Of Guests">
                            ...
                            <p class="text-danger">
                              ...
                              <div class="col-md-12 col-sm-12">
                                   ...
                                   <textarea class="form-control" rows="6" id="cf-message" name="message" placeholder="Tell about your Requirements"></textarea>
